...
// Usando process.env para determinar o modo de autenticação
const AUTH_MODE = process.env.VITE_AUTH_MODE || 'LOCAL';
...
const firebaseRecovery: RecoveryService = {
  async requestRecoveryOtp() { throw new Error("FIREBASE recovery not implemented"); },
  async verifyRecoveryOtp() { throw new Error("FIREBASE recovery not implemented"); }
};

export const recoveryService = AUTH_MODE === 'FIREBASE' ? firebaseRecovery : localRecovery;
